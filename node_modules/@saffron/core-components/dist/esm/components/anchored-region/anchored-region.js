...
class AnchoredRegion extends FASTElement {
    constructor() {
        ...
        this.requestPositionUpdates = () => {
            ...
            // Hide element immediately when position updates are requested
            this.classList.remove('positioned');
         ...
         */
        this.updateLayout = () => {
            // Hide element immediately when recalculation starts
            this.classList.remove('positioned');
        ...
        this.updateRegionStyle = () => {
            ...
            // Only show after positioning is complete and we've waited for the next frame
            if (this.regionVisible && this.initialLayoutComplete) {
                // Use requestAnimationFrame to ensure the transform has been applied before showing
    ...
    setInitialState() {
        ...
        // Immediately hide the element when repositioning starts
        this.classList.remove('positioned');
        this.forceUpdate = false;
