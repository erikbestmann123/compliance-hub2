...
class Slider extends FormAssociatedSlider {
    ...
    setThumbPositionForOrientation(direction) {
        ...
        const transition = this.isDragging ? 'none' : 'all 0.2s ease';
        if (this.orientation === Orientation.horizontal) {
            this.trackStart.style.right = percentageString;
            this.thumb.style.right = percentageString;
        }
        else {
            this.trackStart.style.top = percentageString;
            this.thumb.style.top = percentageString;
        }
        this.trackStart.style.transition = transition;
