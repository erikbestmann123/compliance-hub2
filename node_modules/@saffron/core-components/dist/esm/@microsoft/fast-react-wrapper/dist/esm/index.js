import { FASTElementDefinition, Observable, } from "../../../fast-element/dist/esm/index.js";
 ...
 * @public
 */
export function reactWrapper(React, registry = customElements) {
    function wrap(type, config = {}) {
        ...
        if (cachedCandidates) {
            const cachedWrapper = cachedCandidates.get(name !== null && name !== void 0 ? name : DEFAULT_CACHE_NAME);
            if (cachedWrapper) {
        ...
        class ReactComponent extends React.Component {
            ...
            render() {
                ...
                // ADO#128183
                newReactProps.density = this.props.density;
                // ADO#163017
                newReactProps.id = this.props.id;
        ...
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        wrappersCache.get(type).set(name !== null && name !== void 0 ? name : DEFAULT_CACHE_NAME, reactComponent);
