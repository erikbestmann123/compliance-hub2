...
declare class ButtonBase extends FASTElement {
     ...
     * @public
     */
    a11yAriaControls: string | null;
    /**
     * Indicates the availability and type of interactive popup element, such as menu or dialog, that can be triggered by an element.
     *
     * @public
     */
    a11yAriaHaspopup: 'false' | 'true' | 'menu' | 'listbox' | 'tree' | 'grid' | 'dialog' | string | null;
    /**
     * Indicates whether the element, or another grouping element it controls, is currently expanded or collapsed.
     *
     * @public
     */
    a11yAriaExpanded: 'true' | 'false' | string | null;
    /**
     * Attribute for passing aria-disabled to the button
     *
     * @public
     */
    a11yAriaDisabled: 'true' | 'false' | string | null;
    /**
    ...
    /**
     * attr for passing aria-valuetext to the button
     *
     * @public
     */
    a11yAriaValueText: string;
    /**
    ...
    /**
     * attr for passing aria-pressed to the button
     *
     * @public
     */
    a11yAriaPressed: 'true' | 'false' | 'mixed' | string | null;
}
...
declare class Combobox extends FormAssociatedCombobox {
    ...
    /**
     * Add all the options imperatively removed for virtualization to the DOM
     * Use this function in virtualized mode, right before changing the slotted options, to avoid rendering errors
     * @remarks in React, because we imperatively remove nodes from the DOM in virtualized mode,
     * if the list of nodes changes, React gets confused because it's trying to delete old nodes that we already deleted
     * this function re-adds them to avoid such rendering errors
     */
    reAddOptionsRemovedForVirtualization(): void;
...
declare class TextField extends FormAssociatedTextField {
     ...
     * @public
     * @remarks This ID is automatically generated if not provided. It is used to tie the label and input together.
     * HTML Attribute: id
     */
    id: string;
    /**
    ...
    /**
     * A custom label for the input that is only visible to screen readers.
     * @public
     */
    a11yAriaLabel: string;
    get ariaDescribedbyIds(): string;
...
declare class DatePicker extends FASTElement {
    ...
    optionalText?: string;
    /**
     * Provides the text input with a custom accessible name for assistive technology users, overriding the visible label.
     * @public
     * @passedTo DateMaskedInput
     */
    inputAriaLabel?: string;
...
declare class Dialog extends DialogBase {
    ...
    handleDialogEscape: (e: KeyboardEvent) => boolean;
    connectedCallback(): void;
    disconnectedCallback(): void;
}
...
declare class Drawer extends DialogBase {
    ...
    protected get preventTriggerFocus(): boolean;
    /**
     * Prevents multiple hide() calls from running simultaneously.
     * Guards against animation conflicts when drawer is already closing.
     */
    ...
    disconnectedCallback(): void;
    /**
     * Handles Escape key: only closes the drawer if the event has not already been
     * handled by child components (for example, select, combobox, or date-picker).
     */
...
declare class MenuItem extends FASTElement {
    ...
    /**
     * Hides menu-item from being displayed in the menu housing it.
     *
     * @public
     */
    hidden: boolean;
...
declare class Progress extends FASTElement {
    ...
    ariaValueMax: string;
    /**
     * Defines a human-readable text alternative for the current value.
     * When set, overrides the default format of "{percentComplete}% {completeLabel}".
     * Use this for internationalization to match slotted value content.
     * @public
     * @a11y
     * @remarks
     * HTML Attribute: aria-valuetext
     */
...
declare class ProgressRing extends Progress {
    private static readonly PROGRESS_SEGMENTS;
    /**
...
declare class SearchField extends FormAssociatedSearch {
    ...
    validate(): void;
    /**
     * Handles the submit if the user presses Enter in the input field
     * @public
     */
...
declare class Splitter extends FASTElement {
    ...
    scrollableSecondary: boolean;
    /**
     * attr for passing aria-primary-window-name to the splitter
     *
     * @public
     */
    a11yAriaPrimaryWindowName: string;
    /**
     * attr for passing aria-secondary-window-name to the splitter
     *
     * @public
     */
    a11yAriaSecondaryWindowName: string;
    /**
...
declare class _Prompt extends FASTElement {
}
interface _Prompt extends FormAssociated {
}
declare const FormAssociatedPrompt_base: typeof _Prompt;
/**
 * A form-associated base class for the {@link @saffron/core-components#(Prompt:class)} component.
 *
 * @beta
 */
declare class FormAssociatedPrompt extends FormAssociatedPrompt_base {
    proxy: HTMLTextAreaElement;
}
/**
 ...
 */
declare class Prompt extends FormAssociatedPrompt {
    stopButtonChanged(): void;
    /**
    ...
    /**
     * Visible label text for the input, forwarded to saf-text-area and associated with text area using aria-labeledby. **Note:** this label will take priority over the `textareaAriaLabel`.
     * @public
     */
    label?: string;
    /**
     ...
     */
    processing?: boolean;
    protected processingChanged(prev: boolean, _next: boolean): void;
    /**
     ...
     * @a11y
     */
    textareaAriaDescription: string;
    /**
    ...
    ariaLabel: string;
    /**
     * The ID of an external element to use as the accessible name.
     * @public
     * @a11y
     */
    ariaLabelledby?: string;
    ...
    disabled: boolean;
    /**
     * The error message to display. Sets `invalid` to true.
     * @public
     */
    validationMessage: string;
    /**
    ...
    invalid: boolean;
    /**
     * Maximum number of characters allowed. Enables the character counter if `show-remaining-text` is true.
     * @public
     */
    maxlength?: number;
    /**
...
declare const safAIPromptConfig: {
    readonly events: {
        readonly onInput: "input";
        readonly onChange: "change";
