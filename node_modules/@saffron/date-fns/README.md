...
This is a fork of the original date-fns library. The original library can be found [here](https://date-fns.org/).
This fork aims to patch version 4.1.0 of the original library to make it backwards compatible with older TS versions (v3) that are still in use in some projects using angular 10.
