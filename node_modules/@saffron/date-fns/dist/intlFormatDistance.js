...
function intlFormatDistance(laterDate, earlierDate, options) {
  var value = 0;
  var unit;
  var [laterDate_, earlierDate_] = normalizeDates(options === null || options === void 0 ? void 0 : options.in, laterDate, earlierDate);
  if (!(options !== null && options !== void 0 && options.unit)) {
    // Get the unit based on diffInSeconds calculations if no unit is specified
    var diffInSeconds = differenceInSeconds(laterDate_, earlierDate_); // The smallest unit
  ...
  var rtf = new Intl.RelativeTimeFormat(options === null || options === void 0 ? void 0 : options.locale, _objectSpread2({
    numeric: "auto"
  }, options));
  return rtf.format(value, unit);
}

export { intlFormatDistance as default, intlFormatDistance };
